...
class SystemTest(unittest.TestCase):
    ...
    def test_register_then_login(self):
        ...
        name_input.send_keys("wida")
        mother_name_input.send_keys("yana")
        email_input.send_keys("wida@wida.com")
        password_input.send_keys("wida123")
        ...
        self.login_after_registration("wida@wida.com", "wida123")
